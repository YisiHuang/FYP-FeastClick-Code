                ...
                <form class="layui-form login-bottom">
                    <div class="center">
                        <div class="item">
                            ...
                            <input type="text" name="username" lay-verify="required"  placeholder="Please input username" maxlength="24"/>
                        </div>

                        <div class="item">
                            <span class="icon icon-3"></span>
                            <input type="password" name="password" lay-verify="required"  placeholder="Please input password" maxlength="20">
                            <span class="bind-password icon icon-4"></span>
                        </div>
                    </div>
                    <div class="tip">
                        <a href="javascript:" class="register">Don't have an account? Sign up quickly</a></br>
<%--                        <a href="javascript:" class="forget-password">Forgot your password?</a>--%>
                    </div>
                    <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                        <button class="login-btn" lay-submit="" lay-filter="login">login</button>
                    </div>
                </form>
            </div>
        </div>
