...
<html>
    <head>
        ...
        <style>
            ...
            body {background:url(${pageContext.request.contextPath}/static/plugins/layui/images/sudi_loginbackground.jpg) 0% 0% / cover no-repeat;position:static;font-size:12px;}
                ...
                <form class="layui-form login-bottom">
                    <div class="center">
                        <div class="item">
                            ...
                            <input type="text" name="username" lay-verify="required|username"  placeholder="Please set the user name" maxlength="24" id="username"/>
                        </div>
                        <div class="item">
                            <span class="icon icon-3"></span>
                            <input type="password" name="password" lay-verify="required|password"  placeholder="Please set a 6-12 digit password" maxlength="20" id="password">
                            <span class="bind-password icon icon-4" id="bind-password"></span>
                        </div>
                        <div class="item">
                            <span class="icon icon-3"></span>
                            <input type="password" lay-verify="required|repassword"  placeholder="Please enter your password again" maxlength="20" id="repassword">
                            <span class="bind-password icon icon-4" id="bind-repassword"></span>
                        </div>
                        <div class="item">
                            <span class="icon icon-1"></span>
                            <input type="text" name="phone" lay-verify="required|phone" placeholder="Please enter your mobile phone number" maxlength="24"/>
                        </div>
                    </div>
                    <div class="tip">
                        <a href="javascript:" class="toLogin">Sign in now</a>
                        <a href="javascript:" class="forget-password">Forgot password?</a>
                    </div>
                    <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                        <button class="login-btn" lay-submit="" lay-filter="register">Register Now</button>
                    </div>
                </form>
            </div>
        </div>
