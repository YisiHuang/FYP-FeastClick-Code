    ...
    <body style="background: #ffffff">
        ...
        <div class="userInfoCard">
            <fieldset class="layui-elem-field layui-field-title" style="margin:10px 0;">
                <legend>
                    <i class="fa fa-id-card-o" style="color: #009688"></i>&nbsp;&nbsp;<font color="#009688">My Account Information</font>
                </legend>
                <button type="button" class="layui-btn layui-btn-primary" id="modifyUserInfo" style="color: #009688">
                    <i class="fa fa-edit" style="color: #009688;"></i>&nbsp;&nbsp;Modify Information
                </button>
            </fieldset>
...
<%--                                <th>Sign up Date</th>--%>
<%--                                <td id="registerDate"></td>--%>
<%--&lt;%&ndash;                                <th>Last Log Out Time</th>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                <td id="lastLogoutTime"></td>&ndash;%&gt;--%>
...
<%--                            </tr>--%>
        ...
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>
                <i class="fa fa-tags" style="color: #009688"></i>&nbsp;&nbsp;<font color="#009688">Application</font>
            </legend>
            <div class="userinfo-area">
                <div class="layui-inline userinfo-img">
                    <a href="${pageContext.request.contextPath}/reception/myOrder.html">
                        <img src="${pageContext.request.contextPath}/static/resources/images/orders.png">
                    </a>
                </div>
                <div class="layui-inline userinfo-img">
                    <a href="${pageContext.request.contextPath}/reception/myTicket.html">
                        <img src="${pageContext.request.contextPath}/static/resources/images/coupons.png">
                    </a>
                </div>
                <div class="layui-inline userinfo-img">
                    <a href="${pageContext.request.contextPath}/reception/myComments.html">
                        <img src="${pageContext.request.contextPath}/static/resources/images/comments.png">
                    </a>
                </div>
                <div class="layui-inline userinfo-img">
                    <a href="${pageContext.request.contextPath}/reception/myComplaint.html">
                        <img src="${pageContext.request.contextPath}/static/resources/images/cmplaint.png">
                    </a>
                </div>
            </div>
        </fieldset>
        ...
        <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
            <legend>
                <i class="fa fa-building" style="color: #009688"></i>&nbsp;&nbsp;<font color="#009688">Desk Management</font>
            </legend>
            <div>
                <%-- 表格头部工具栏 --%>
            ...
            <form class="layui-form" style="width: 90%" id="dataForm" lay-filter="dataForm">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="birthday" autocomplete="off" placeholder="Please input birthday date" class="layui-input" id="birthday">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">Gender</label>
                    <div class="layui-input-block">
                        <input type="radio" name="gender" value="0" title="None">
        ...
        <div class="layui-container" style="display: none;padding: 5px;width: 100%" id="addOrUpdateForm">
            <form class="layui-form" style="width: 90%" id="addressDataForm" lay-filter="dataForm">
                ...
                <input type="hidden" name="userId" id="userId">
                <div class="layui-form-item">
                    <label class="layui-form-label"><font color="red"> * </font>First choice</label>
                    <div class="layui-input-block">
                        <input type="radio" name="defaulted" value="1" title="Yes" checked>
                        <input type="radio" name="defaulted" value="0" title="No">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label"><font color="red"> * </font>Desk Number</label>
                    <div class="layui-input-block">
            ...
            <div class="layui-container userinfo-container">
                {{#  layui.each(d.list, function(index, item){ }}
                    <div class="layui-col-md4 userinfo-item">
                        ...
                        <span>{{ item.site || 'unfilled' }}</span>
                {{#  }); }}
                {{#  if(d.list.length === 0){ }}
                        <span>No Data, please add</span>
                {{#  } }}
                    </div>
            </div>
        </fieldset>
    ...
    <script>
        ...
        <%--document.getElementById("lastLoginTime").innerHTML = formatDate(new Date("${sessionScope.userLogin.lastLoginTime}"));--%>
        ...
        layui.use(['jquery', 'laytpl', 'layer', 'form', 'laydate', 'table'], function() {
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'addressId', width: 120, title: 'ID', sort: true, align: "center"},
                    {field: 'defaulted', width: 120, title: 'First Choice', templet: function (d) {
                        switch (d.defaulted) {
                            case 1:
                    ...
                    {field: 'address', minWidth: 450, title: 'Desk Number', align: "center", sort: true},
                    {title: 'Operation', width: 200, toolbar: '#currentTableBar', align: "center"}
                ]],
                limits: [5],
                limit: 5,
                page: true,
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'edit') {
                    ...
                    layer.confirm('Sure you want to delete the address?', {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
