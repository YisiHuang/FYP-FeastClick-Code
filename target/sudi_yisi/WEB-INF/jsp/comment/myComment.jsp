        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header" style="position: relative;margin-left: 44px;">
                    ...
                    <p class="navbar-text" style="position:absolute;top: 0px;left: 68px;width: 199px;">My Comment</p>
                </div>
            </div>
        </nav>
            ...
            <div class="lf tu-prk" style="width: 100%;">
                <div class="tu-pr">
                    <div class="qing cpxk shu12 layui-form-item" style="padding: 22px 30px 22px;line-height: 28px;position: relative">
                        ...
                        <div>
                            <div class="layui-form-item">Post a comment after purchasing【{{ comment.skuName }}】: </div>
                            ...
                            <div style="color: #ffb800;font-size: 17px;" class="layui-inline">Rating: {{ comment.commentScore }} <i class="layui-icon layui-icon-star-fill"></i></div>
                            <div style="float: right">Comment time: {{ formatDateTime(comment.commentTime) }}</div>
