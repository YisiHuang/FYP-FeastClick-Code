...
<html>
    <head>
        <meta charset="utf-8">
        <title>Dish Group Type Management</title>
            ...
            <div class="layuimini-main">
                ...
                <div class="layui-container" style="display: none;padding: 5px;width: 100%;" id="addOrUpdateForm">
                    <form class="layui-form" style="width: 90%" id="dataForm" lay-filter="dataForm">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label"><font color="red"> * </font>Group Name</label>
                            <div class="layui-input-inline">
                                <input type="text" name="typeName" lay-verify="required" autocomplete="off" class="layui-input" id="typeName">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label"><font color="red"> * </font>Group Description</label>
                            <div class="layui-input-block">
                                <textarea name="typeDesc" placeholder="Please input content" lay-verify="required" class="layui-textarea" id="typeDesc" style="height: 120px;"></textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <div class="layui-inline" style="width: 100%">
                                <label class="layui-form-label"><font color="red"> * </font>Group Picture</label>
        ...
        layui.use(['form', 'table', 'jquery', 'upload', 'layer'], function () {
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'typeId', width: 160, title: 'Number', align: "center", sort: true},
                    {field: 'typeName', minWidth: 140, title: 'Group Name', align: "center"},
                    {field: 'lastModifyBy', width: 140, title: 'Last Modify By', align: "center"},
                    {field: 'lastModifyTime', width: 200, title: 'Last Modify Time', align: "center", sort: true,
                        templet:"<div>{{layui.util.toDateString(d.lastModifyTime, 'yyyy-MM-dd HH:mm:ss')}}</div>"
                    },
                    {field: 'typeStatus', width: 140, title: 'Status', sort: true, align: "center",
                        templet: function (d) {
                            if (d.typeStatus == 1){
                                flag = true;
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'edit') {
                    ...
                    var str = 'Are you sure you want to downgrade category <font color="red">【' +data.typeName+ '】</font>?\nThe take down action will prevent users from viewing all dishes under the category properly.';
                    ...
                    var str = 'Are you sure you want to restore the category <font color="red">【' +data.typeName+ '】</font>to the shelf?';
                    layer.confirm(str, {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
                    ...
                    var str = 'Are you sure you want to delete category <font color="red">【' +data.typeName+ '】</font>?\nDeleting a dish category must ensure that no dish belongs to the category!';
                    layer.confirm(str, {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
