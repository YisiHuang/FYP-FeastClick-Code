    ...
    <script id="demo1" type="text/html">
        <div data-am-widget="tabs" class="am-tabs am-tabs-default">
            <ul class="am-tabs-nav am-cf" id="foodtype-nav">
                <li class="">
                    <span style="color: #1e9fff;line-height: 42px;text-overflow: ellipsis;display: block;font-size: 18px;word-wrap: normal;overflow: hidden;white-space: nowrap;text-decoration: none;">Dish Type</span>
                </li>
                            ...
                            <dd style="background-color:#1aa0940a;">
                                ...
                                <div style="border:1px solid #1e9fff;border-radius: 50px; height: 45px;color: #1e9fff;">
                                    <a href={{ foodInfoPath }} style="color: #1e9fff;">
                                        <div style="width: 100%;text-align: center;font-size: 16px;line-height: 45px;">View Details</div>
                                    </a>
                                </div>
                            </dd>
                    {{#     }
