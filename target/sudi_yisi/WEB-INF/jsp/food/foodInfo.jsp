...
<html>
    <head>
        ...
        <title>Food Deatails Information</title>
    ...
    <script id="commentTemplate" type="text/html">
        <div class="qing juzhong">
            <div class="lf tu-prk" style="width: 100%;">
                <div class="tu-pr">
                    <div class="tu-pr-ti">
                        <a href="javascript:void(0)" name="q1" class="tinn">User Reviews（{{ d.list[0].commentCount }} reviews in total）</a>
                    </div>
                    <div class="qing cpxk shu12 layui-form-item" style="padding: 22px 30px 22px;line-height: 28px;position: relative">
                        ...
                        <div style="position: relative;">
                            ...
                            <div class="layui-inline been-buy">Previously purchased{{ comment.skuName }}</div>
                            <div class="commentTime">Comment Time：{{ formatDateTime(comment.commentTime) }}</div>
    ...
    <script id="demo" type="text/html">
        ...
        <div class="qing juzhong prbg" style="position: relative;">
            ...
            <div style="position: absolute;right: 28px;top: 28px;">
                <a href="javascript:window.history.go(-1);">
                    <button type="button" class="layui-btn layui-btn-primary" style="width: 80px;padding-right: 25px;">Back<i class="layui-icon layui-icon-right" style="position: absolute;top: 2px;right: 5px;"></i></button>
                </a>
            </div>
            <style>
            ...
            <div class="lf pryo">
                ...
                <div class="pr-jgk">
                    <div class="pr-jti" style="height: 28px;">
                        <b>Price：</b>€<span id="skuPrice">{{ d.list.foodSkuList[0].skuPrice }}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Have Saled: <span id="skuSale">{{ d.list.foodSkuList[0].skuSale }}</span></strong>
                    </div>
                    <div class="pr-jck">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            {{# console.log(d.list.foodSpu) }}
                            <tbody><tr>
                                <td width="120"><div class="pr-jc"><div class="cuk">Views</div><div class="pr-jcf">Number of Views：{{ d.list.foodSpu.foodViewCount }}<span></span></div></div></td>
                                <td width="140"><div class="pr-jc"><div class="cuk">Sales volume</div><div class="pr-jcf">Sales Volume：{{ d.list.foodSpu.foodSaleCount }}<span></span></div></div></td>
                            </tr>
                            </tbody></table>
                    </div>
                </div>
        ...
        <div class="qing juzhong">
            <div class="lf tu-prk" style="width: 100%;">
                <div class="tu-pr">
                    <div class="tu-pr-ti">
                        <a href="javascript:void(0)" name="q1" class="tinn">Food Information</a>
                    </div>
                    <div class="qing cpxk shu12" style="padding: 22px 30px 0px;line-height: 28px;">
                        <p style="float:left;width:50%;display:inline-block;padding: 0px; margin-top: 0px; margin-bottom: 0px; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal;">
                            <font color="#1bac9f">【Dish Information】</font>{{ d.list.foodSpu.foodName }}
                        </p>
                        <p style="float:left;width:50%;display:inline-block;padding: 0px; margin-top: 0px; margin-bottom: 0px; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal;">
                            <font color="#1bac9f">【Ingredients】</font>{{ d.list.foodSpu.foodIngredient }}
                        </p>
                        <p style="float:left;width:50%;display:inline-block;padding: 0px; margin-top: 0px; margin-bottom: 0px; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal;">
                            <font color="#1bac9f">【Meat/Vegetable】</font>{{ d.list.foodSpu.foodVegon }}
                        </p>
                        <p style="float:left;width:50%;display:inline-block;padding: 0px; margin-top: 0px; margin-bottom: 0px; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal;">
                            <font color="#1bac9f">【Allergens】</font>{{ d.list.foodSpu.foodCookWay }}
                        </p>
                        <p style="line-height:22px;padding: 0px; margin-top: 0px; margin-bottom: 0px; color: rgb(51, 51, 51); font-family: Arial, Helvetica, sans-serif; font-size: 14px; white-space: normal;">
                            <font color="#1bac9f">【Calorific Value】</font>{{ d.list.foodSpu.foodDesc }}
                        </p>
                        <p><br></p>
                    </div>
                </div>
