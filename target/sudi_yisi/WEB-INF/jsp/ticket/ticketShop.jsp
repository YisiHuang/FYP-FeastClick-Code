...
<html>
    ...
    <body>
        ...
        <div style="width:100%; height:100px; background:url(${pageContext.request.contextPath}/static/plugins/Ruidan_Page/images/header_bgV2.png) no-repeat top center">
            <img src="${pageContext.request.contextPath}/static/plugins/Ruidan_Page/images/CouponHead.png" style="width:1200px; margin:0 auto;">
        </div>
                ...
                <a class="coupon-a" id={{ clickId }} href="javascript:void(0)">
                    <div class="coupon-left">
                        <div class="pro-content">
                            ...
                            <span class="ticket-info" style="color: #999999;position: absolute;top: 43px;left: 24px;font-size: 13px;">Expires {{ ticketType.liveTime }} day(s) after collection</span>
                            <div class="pro-price" style="position: absolute;top: 62px;left: 20px;">
                                ...
                                <span class="price-info">Available Over{{ ticketType.requirement }}</span>
                            </div>
                            <span style="position: absolute;top: 71px;left: 177px;font-size: 13px;color: orange">Points: {{ ticketType.needScore }}</span>
                        </div>
                    </div>
                    <div class="coupon-right">
                        ...
                        <div class="change-block">
                            ...
                            <span class="progress-text">Collected: {{ ticketType.receive }}</span>
                            <span class="coupon-btn">Redeem Now</span>
                        </div>
                    </div>
                </a>
            </li>
        ...
        layui.use(['jquery', 'layer', 'laytpl'], function () {
            ...
            $.post("${pageContext.request.contextPath}/reception/ticket/findAll", function (result) {
                ...
                $(".coupon-a").click(function () {
                    ...
                    var needScore = $(this).children().eq(0).children().eq(0).children().eq(3).text().split("：")[1]; //to spend<font color="#ff4500">【' + needScore + ' points】</font>
                    layer.confirm('Sure you want to redeem that coupon?', {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
