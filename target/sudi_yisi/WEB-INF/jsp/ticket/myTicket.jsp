        ...
        <nav class="navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header" style="position: relative;margin-left: 44px;">
                    ...
                    <p class="navbar-text" style="position:absolute;top: 0px;left: 68px;width: 199px;">My Coupon</p>
                </div>
            </div>
        </nav>
        <div id="view"></div>
    ...
    <script type="text/html" id="demo">
        ...
        {{# layui.each(d.list, function(index, ticket){ }}
            <div class="stamp stamp01" style="float: left;margin-left: 20px;">
                <div class="par">
                    <p>FeastClick</p>
                    <sub class="sign">€</sub><span style="font-size: 45px;">{{ (ticket.cheap).toFixed(2) }}</span><sub>Coupon</sub>
                    <p>Orders Over{{ ticket.requirement }}€</p>
                </div>
        ...
        layui.use(['jquery', 'layer', 'laytpl'], function () {
            ...
            $.post("${pageContext.request.contextPath}/reception/ticket/findByUser", function (result) {
                if (result.flag){
                    ...
                    alert("You don't have a coupon yet, check out the coupon mall!");
                }
            }, "json");
