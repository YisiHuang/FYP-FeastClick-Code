                        ...
                        <form class="layui-form layui-form-pane" action="" id="searchForm">
                            <div class="layui-form-item">
                                <div class="layui-inline">
                                    <label class="layui-form-label">Distributor Number</label>
                ...
                <script type="text/html" id="currentTableBar">
                    {{# if(!flag){ }}
                        <a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete" lay-event="reJoin" id="reJoin">
                            <i class="layui-icon layui-icon-refresh-1"></i>Reinstatement
                        </a>
                    {{# } else{}}
                        ...
                        <a class="layui-btn layui-btn-xs layui-btn-danger data-count-delete" lay-event="leave" id="leave">
                            <i class="layui-icon layui-icon-pause"></i>Retire
                        </a>
                        <a class="layui-btn layui-btn-xs layui-btn-checked data-count-grant" lay-event="workData">
                            <i class="layui-icon layui-icon-survey"></i>Distribute Data
                        </a>
                    {{# }}}
                </script>
                    ...
                    <form class="layui-form" style="width: 90%" id="dataForm" lay-filter="dataForm">
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline layui-col-md5">
                                <label class="layui-form-label"><font color="red"> * </font>Photo of Certificate</label>
                            ...
                            <div class="layui-form-text layui-inline-input layui-col-md6">
                                ...
                                <div class="layui-input-block">
                                    <textarea name="remark" placeholder="Please enter content" class="layui-textarea" id="remark" style="width:295px;height: 200px;"></textarea>
                                </div>
                            </div>
                        </div>
        ...
        layui.config({
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'deliverId', minWidth: 160, title: 'Distributor Number', align: "center"},
                    {field: 'realName', width: 112, title: 'Real Name', align: "center", templet: function (d) {
                        if (d.realName==null || d.realName=='')
                            return "<font color='red'>Unnamed</font>";
                        else return d.realName;
                    }},
                    {field: 'phone', width: 130, title: 'Phone Number', align: "center"},
                    {field: 'orderCount', width: 100, title: 'Number of Orders', align: "center", sort: true},
                    {field: 'faultCount', width: 100, title: ' Number of Poor Ratings', align: "center", sort: true},
                    {field: 'finishCount', width: 100, title: 'Number of Completions', align: "center", sort: true},
                    {field: 'joinDate', width: 120, title: 'Entry Date', sort: true, align: "center",
                        templet:"<div>{{layui.util.toDateString(d.lastLoginTime, 'yyyy-MM-dd')}}</div>"
                    },
                    {field: 'leaveDate', width: 120, title: 'Separation or Not', sort: true, align: "center",
                        templet: function (d) {
                            if (d.leaveDate == null){
                                flag = true;
                                return "<font color='blue'>Incumbency</font>";
                            }else {
                                flag = false;
                                return "<font color='red'>Retire</font>";
                            }
                        }
                    },
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.code == 1){
                        ...
                        $("#username").append(new Option("No Data Available", ""));
                    }
                }
            });
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'edit') {
                    ...
                    layer.confirm('Sure you want to perform a separation operation on <font color="red">【' +data.realName+ '】</font>?', {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
                    ...
                    layer.confirm('Sure you want to do a reinstatement operation on <font color="red">【' +data.realName+ '】</font>?', {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
                    ...
                    layer.open({
                        ...
                        success: function () {
                            ...
                            $.post("${pageContext.request.contextPath}/backstage/deliver/findMax", function (result) {
                                ...
                                var option = {
                                    title: {
                                        text: 'Radar Chart of Distributor Work Data'
                                    },
                                    tooltip: {},
                                    legend: {
                                        data: 'Work Data',
                                    ...
                                    radar: {
                                        ...
                                        indicator: [
                                            { name: 'Number of Orders Received', max: maxOrderCount},
                                            { name: 'Number of Poor Ratings', max: maxFaultCount},
                                            { name: 'Number of Completions', max: maxFinishCount}
                                        ]
                                    },
                                    series: [{
                                        type: 'radar',
