            ...
            <div class="layuimini-main">
                ...
                <script type="text/html" id="toolbarDemo">
                    <div class="layui-btn-container">
                        <button class="layui-btn layui-btn-normal layui-btn-sm data-add-btn" lay-event="add">
                            <i class="layui-icon layui-icon-add-1"></i>Add </button>
                    </div>
                </script>
                ...
                <script type="text/html" id="currentTableBar">
                    ...
                    <a class="layui-btn layui-btn-xs layui-btn-checked data-count-grant" lay-event="grant">
                        <i class="layui-icon layui-icon-about"></i>Authorisation Menu
                    </a>
                </script>
                ...
                <div style="display: none;padding: 5px" id="addOrUpdateForm">
                    <form class="layui-form" style="width: 90%" id="dataForm" lay-filter="dataForm">
                        ...
                        <div class="layui-form-item">
                            <label class="layui-form-label"><font color="red"> * </font>Role Name</label>
                            <div class="layui-input-block">
                                <input type="text" name="roleName" lay-verify="required" autocomplete="off" placeholder="Please input role name" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label"><font color="red"> * </font>Role Description</label>
                            <div class="layui-input-block">
                                <textarea name="roleDesc" lay-verify="required" autocomplete="off" placeholder="Please input role description" class="layui-textarea"></textarea>
                            </div>
                        </div>
            ...
            layui.extend({
                ...
                var tableIns = table.render({
                    ...
                    cols: [[
                        ...
                        {field: 'roleId', width: 120, title: 'Role Number', sort: true, align: "center"},
                        {field: 'roleName', width: 160, title: 'Role Name', align: "center"},
                        {field: 'roleDesc', minWidth: 300, title: 'Role Description', align: "center"},
                        {field: 'lastModifyBy', width: 160, title: 'Modifier', align: "center"},
                        {field: 'lastModifyTime', width: 200, title: 'Modify Time', align: "center", sort:true,
                ...
                table.on('tool(currentTableFilter)', function (obj) {
                    ...
                    if (obj.event === 'edit') {
                        ...
                        layer.confirm('Sure you want to delete the role named <font color="#ff4500">【' + data.roleName + '】</font>?', {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
                        ...
                        index = layer.open({
                            title: 'Menu authorisation for role [<font color="red">'+data.roleName+'</font>]',
                            type: 1,
                            shade: 0.2,
                            maxmin:true,
                            shadeClose: true,
                            ...
                            yes: function(index, layero){ //确定按钮的回调
                                ...
                                if (param.length > 0){//判断是否选中了复选框
                                    ...
                                    layer.msg("Please select at least one of the checkboxes!");
                                }
                            },
