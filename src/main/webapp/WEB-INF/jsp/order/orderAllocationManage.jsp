...
<html>
    <head>
        <meta charset="utf-8">
        <title>Order Distribution Management</title>
            ...
            <div class="layuimini-main">
                ...
                <script type="text/html" id="currentTableBar">
                    <a class="layui-btn layui-btn-normal layui-btn-xs data-count-edit" lay-event="findOrderDetail">
                        <i class="layui-icon layui-icon-edit"></i>View Order
                    </a>
                    <a class="layui-btn layui-btn layui-btn-xs data-count-edit" lay-event="deliver">
                        <i class="layui-icon layui-icon-cart"></i>Distribute Waiter
                    </a>
                    <a class="layui-btn layui-btn-danger layui-btn-xs data-count-edit" lay-event="delete">
                        <i class="layui-icon layui-icon-delete"></i>Cancelled Order
                    </a>
                </script>
                    ...
                    <form class="layui-form">
                        ...
                        <div class="layui-form-item">
                            <div style="margin: 0 auto;width: 325px;">
                                <label class="layui-inline"><font color="red"> * </font>Please select a waiter:</label>
                            ...
                            <div class="layui-form-item" style="margin-top: 30px;">
                                <div class="layui-input-block" style="text-align: center;margin-left: 0px;">
                                    <button type="button" class="layui-btn layui-btn-checked" lay-submit lay-filter="doSubmit">
                                        <span class="layui-icon layui-icon-add-1"></span>Distribute Orders
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        layui.use(['form', 'table', 'jquery', 'laytpl'], function () {
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'realName', width: 120, title: 'Receiver', sort: true, align: "center"},
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'findOrderDetail') {
                    ...
                    layer.confirm('Are you sure you want to cancel this order?This operation must be confirmed <font color="red">by user</font>！', {icon: 3, title:'Alert', btn: ['Sure', 'Close']}, function(index){
                        //请求后端取消订单
