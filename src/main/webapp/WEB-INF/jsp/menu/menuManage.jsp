                        ...
                        <div style="display: none;padding: 5px" id="addOrUpdateForm">
                            <form class="layui-form" id="dataForm" lay-filter="dataForm">
                                ...
                                <div class="layui-form-item">
                                    <label class="layui-form-label">Initial Menu</label>
                                ...
                                <div class="layui-form-item" style="width: 97%;">
                                    ...
                                    <div class="layui-input-block">
                                        <input type="text" name="title" lay-verify="required" autocomplete="off" placeholder="Please input dish name" class="layui-input" id="title">
                                    </div>
                                </div>

                                <div class="layui-form-item" style="width: 97%;">
                                    <label class="layui-form-label">Menu Address</label>
                                    <div class="layui-input-block">
                                        <input type="text" name="href" autocomplete="off" placeholder="Please input menu address" class="layui-input" id="href">
                                    </div>
                                </div>

                                <div class="layui-form-item">
                                    <label class="layui-form-label">Menu Icon</label>
                                ...
                                <div class="layui-form-item">
                                    <label class="layui-form-label"><font color="red"> * </font>Unfold or Not</label>
                                    <div class="layui-input-block">
                                ...
                                <div class="layui-form-item layui-row">
                                    <div class="layui-input-block" style="margin-left: 38%;">
                                        ...
                                        <a class="layui-btn layui-btn-danger" lay-filter="doReset" id="doReset">
                                            <span class="layui-icon layui-icon-delete"></span>Clear
                                        </a>
                                    </div>
                                </div>
                            </form>
        ...
        layui.extend({
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'id', width: 112, title: 'Menu Number', sort: true, align: "center"},
                    {field: 'title', width: 140, title: 'Menu Name', align: "center"},
                    {field: 'href', minWidth: 200, title: 'Menu Address', align: "center"},
                    {
                        field: 'spread', width: 100, title: 'Unfold or Not', align: "center",
                        templet: function (d) {
                            switch (d.spread) {
                                case 0:
                                    return "<font color='blue'>No</font>";
                                case 1:
                                    return "<font color='#ff4500'>Yes</font>";
                                default:
                                    return "Unknown";
                            }
                        },
                    ...
                    {
                        field: 'icon', width: 100, title: 'Menu Icon', align: "center",
                        templet: function (d) {
                            return "<i class='" + d.icon + "'></i>";
                        }
                    },
                    {title: 'Operation', width: 180, toolbar: '#currentTableBar', align: "center"}
                ]],
            ...
            var selectTree = dtree.renderSelect({
                ...
                skin: "layui",
                ficon: ["0", "7"],
                selectTips: "Please select, if you don't, it will be the top menu by default.", //下拉框默认提示语
                response: {message: "msg", statusCode: 0}, //修改response中返回数据的定义
            ...
            table.on("tool(currentTableFilter)", function (obj) {
                if (obj.event === "edit"){
                    ...
                    layer.confirm('Sure you want to delete the menu <font color="red">【'+ obj.data.title +'】</font>?',{icon: 3, title:'Alert', offset: ['150px', '450px'], btn: ['Sure', 'Close']},function(index){
