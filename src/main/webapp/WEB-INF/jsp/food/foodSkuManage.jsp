...
<html>
    <head>
        <meta charset="utf-8">
        <title>Dish SKU Management</title>
                    ...
                    <div style="margin: 10px 10px 10px 10px">
                        <form class="layui-form layui-form-pane" action="" id="searchForm">
                            <div class="layui-form-item">
                                ...
                                <div class="layui-inline">
                                    <label class="layui-form-label">Dish Price</label>
                                    <div class="layui-input-inline">
                                        <input type="text" name="skuPrice" autocomplete="off" class="layui-input" onkeyup="clearNoNum(this)">
                                    </div>
                                </div>
                                <%--<div class="layui-inline">--%>
                                <%--    <label class="layui-form-label">Dish Supply</label>--%>
                                <%--    <div class="layui-input-inline">--%>
                    ...
                    <form class="layui-form" style="width: 90%" id="dataForm" lay-filter="dataForm">
                            ...
                            <div class="layui-inline layui-col-md6" style="margin-right: 0px;">
                                ...
                                <div class="layui-input-inline">
                                    <select id="typeId" name="typeId" style="height: 32px;width: 150px;text-align: center;" lay-verify="required" lay-filter="typeId">
                                        <option value="" selected="selected">Please select dish group</option>
                                    </select>
                                </div>
                            </div>
                            <div class="layui-inline layui-col-md6" style="margin-right: 0px;">
                                ...
                                <div class="layui-input-inline">
                                    <select id="foodIdSelect" name="foodId" style="height: 32px;width: 150px;text-align: center;" lay-verify="required">
                                        <option value="" selected="selected">Please select dish group first</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item layui-row" style="margin-right: 0px;">
                            <div class="layui-inline layui-col-md12" style="margin-right: 0px;">
                                <label class="layui-form-label"><font color="red"> * </font>Specification Name</label>
                                <div class="layui-input-inline" style="margin-right: 0px;width: 77.5%;">
                                    <%--取名为skuName，实质是foodvalueName， 后端拼接--%>
                                    <input type="text" placeholder="Please input specification name" autocomplete="off" class="layui-input" name="skuName" id="foodvalueName" lay-verify="required">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="layui-form-item">
                            <div class="layui-inline layui-col-md6 my-inline" style="margin-right: 0px;">
                                <label class="layui-form-label">SKU Price</label>
                                <div class="layui-input-inline">
                                    <input type="text" placeholder="Please input SKU price" autocomplete="off" class="layui-input" name="skuPrice" id="skuPrice" onkeyup="clearNoNum(this)">
                                </div>
                            </div>
                            <%--<div class="layui-inline layui-col-md6 my-inline" style="margin-right: 0px;">--%>
                            <%--    <label class="layui-form-label">SKU  inventories</label>--%>
                            <%--    <div class="layui-input-inline">--%>
                            <%--        <input type="text" placeholder="Please input SKU inventories" autocomplete="off" class="layui-input" name="skuStock" id="skuStock" onkeyup="value.replace(/[^0-9]/g,'')">--%>
                            <%--    </div>--%>
                            <%--</div>--%>
                        </div>
        ...
        layui.use(['form', 'table', 'jquery', 'upload', 'layer'], function () {
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'skuId', width: 160, title: 'SKU Number', align: "center", sort: true},
                    {field: 'skuName', minWidth: 140, title: 'SKU Name', align: "center"},
                    {field: 'foodName', minWidth: 140, title: 'SPU Name', align: "center"},
                    {field: 'typeName', minWidth: 140, title: 'Type', align: "center"},
                    {field: 'skuPrice', minWidth: 140, title: 'Price', align: "center", templet: function (d) {
                        if (d.skuPrice == null)
                            return "<font color='#ff7f50'>Uncompleted</font>";
                        else return d.skuPrice;
                    }},
                    // {field: 'skuStock', minWidth: 140, title: 'SKU Supply', align: "center", templet: function (d){
                    //     if (d.skuStock == 0)
                    //         return "<font color='red'>Sale out</font>";
                    //     if (d.skuStock < 5)
                    //         return "<font color='#ff7f50'>Low inventories</font>"
                ...
                if (obj.event === 'add') {  // 监听添加操作
                    index = layer.open({
                        ...
                        success: function () {
                            //移除不可修改并添加校验
                            $("#foodIdSelect").empty();
                            $("#foodIdSelect").append(new Option("Please select dish group first", ""));
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'edit') {
                    ...
                    var str = 'Are you sure you want to delete the dish SKU for the operation?\nThis SKU information will not exist after deletion!';
                    console.log(data);
