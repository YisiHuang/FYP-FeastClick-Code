...
<html>
    <head>
        <meta charset="utf-8">
        <title>Food SKU Specification Group Management</title>
                    ...
                    <form class="layui-form" style="width: 90%" id="dataForm" lay-filter="dataForm">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-inline layui-col-md8">
                                <input type="text" name="foodattrName" placeholder="Please enter the group name" lay-verify="required" autocomplete="off" class="layui-input" id="foodattrName">
                            </div>
                        </div>
        ...
        layui.use(['form', 'table', 'jquery', 'layer'], function () {
            ...
            var tableIns = table.render({
                ...
                cols: [[
                    ...
                    {field: 'foodattrId', width: 160, title: 'Number', align: "center", sort: true},
                    {field: 'foodattrName', minWidth: 140, title: 'Name', align: "center"},
            ...
            table.on('tool(currentTableFilter)', function (obj) {
                ...
                if (obj.event === 'edit') {
                    ...
                    var str = 'Are you sure you want to perform a delete operation on category <font color="red">【' +data.foodattrName+ '】</font>?\nDeleting a dish specification group must ensure that no specification is using that specification group!';
