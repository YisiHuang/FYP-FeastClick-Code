...
<html>
    <head>
        <meta charset="utf-8">
<%--        <title>Feast Click Control</title>--%>
        <title>Title</title>
                    ...
                    <ul class="layui-nav layui-layout-right">
                        ...
                        <li class="layui-nav-item layuimini-setting">
                            ...
                            <dl class="layui-nav-child">
                                <dd>
                                    <a href="javascript:;" layuimini-content-href="${pageContext.request.contextPath}/userInfo.html" data-title="Basic Information" data-icon="fa fa-gears">Personal Account</a>
                                </dd>
                                <dd>
                                    <a href="javascript:;" id="modifyPassword" data-title="Modify Password" data-icon="fa fa-gears">Modify Password</a>
                                </dd>
                                <dd>
                                    <hr>
                                </dd>
                        ...
                        <li class="layui-nav-item layuimini-select-bgcolor" lay-unselect>
                            <a href="javascript:;" data-bgcolor="Colour Scheme"><i class="fa fa-ellipsis-v"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="layui-form-item layui-row layui-col-md12">
                    <div class="layui-input-block" style="text-align: center">
                        <button type="button" class="layui-btn layui-btn-checked" lay-submit lay-filter="doSubmit">
                            <span class="layui-icon layui-icon-add-1"></span>Verify Modification
                        </button>
        ...
        <script>
            layui.use(['jquery', 'layer', 'miniAdmin','miniTongji', 'form'], function () {
                ...
                $('.login-out').on("click", function () {
                    layer.confirm('Sure you want to log out?', {icon: 3, title:'Alert', area: ['240px', '160px'], offset: 't', btn: ['Sure', 'Close']}, function(index){
