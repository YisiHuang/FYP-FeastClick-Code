...
public class OrderServiceImpl implements OrderService {
    ...
    public Map<String, Object> allocationOrder(String deliverId, String orderId) {
        ...
        try{
            ...
            map.put(SystemConstant.MESSAGE, "【"+deliver.getRealName()+"】will distribute the order");
        }catch (RuntimeException e) {
            map.put(SystemConstant.FLAG, false);
            map.put(SystemConstant.MESSAGE, "Failed to distribute the order");
        }
        return map;
    }
    ...
    public Map<String, Object> finishOrder(HttpSession session, String orderId) {
        ...
        try {
            ...
            map.put(SystemConstant.FLAG, true);
            map.put(SystemConstant.MESSAGE, "Dish have been successfully distributed!");
        }catch (RuntimeException e) {
            map.put(SystemConstant.FLAG, true);
            map.put(SystemConstant.MESSAGE, "Dish have been successfully distributed!");
        }
